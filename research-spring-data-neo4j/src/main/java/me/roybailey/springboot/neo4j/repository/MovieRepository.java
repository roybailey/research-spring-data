...
public interface MovieRepository extends GraphRepository<Movie> {
    ...
    /**
     * Simple auto-derived finder by returning relationship objects
     * @param title to match
     * @return actors in movie
     */
    Set<Person> findActedInByTitle(String title);


    /**
     * Custom finder returning relationship objects
    ...
    /**
     * Custom finder returning custom objects
     */
    @QueryResult
    class MovieData {
        Movie movie;
